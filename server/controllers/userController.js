...
module.exports.setAvatar=async (req,res,next)=>{
    try{
        ...
        });  // If you set the update values here only, then userData const will contain the previous value of user before updating. And to get new value you need to again use findIDByUpdate.
